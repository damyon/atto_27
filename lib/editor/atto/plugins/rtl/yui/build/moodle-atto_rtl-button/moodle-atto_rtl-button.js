    ...
    init : function(params) {
        var click = function(e, elementid, direction) {
            ...
            if (M.atto_rtl.selection !== false && (!M.atto_rtl.selection.collapsed)) {
                ...
                // Remove the opposite direction class and add new direction.
        ...
        M.editor_atto.add_toolbar_button(params.elementid, 'rtl', iconurl, params.group, rtlclick);

        iconurl = M.util.image_url('e/left_to_right', 'core');
